...
function cambiaDirezione(event){
    ...
    if(codice == 37 && codice != 38 && codice != 39 && codice != 40){
        direzione = "sx";
    }
    if(codice == 38 && codice != 37 && codice != 39 && codice != 40 ){
        direzione = "up";
    }
    if(codice == 39 && codice != 37 && codice != 38 && codice != 40 ){
        direzione = "dx";
    }
    if(codice == 40 && codice != 38 && codice != 39 && codice != 37 ){
        direzione = "dw";
    }
